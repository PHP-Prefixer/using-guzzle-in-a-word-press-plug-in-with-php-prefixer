...
use PPP\GuzzleHttp\Exception\InvalidArgumentException;
use PPP\GuzzleHttp\Handler\CurlHandler;
use PPP\GuzzleHttp\Handler\CurlMultiHandler;
use PPP\GuzzleHttp\Handler\Proxy;
use PPP\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \PPP\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
