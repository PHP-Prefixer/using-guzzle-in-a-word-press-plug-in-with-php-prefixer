...
class HandlerStackTest extends TestCase
{
    ...
    public function testCanPrintMiddleware()
    {
        ...
        self::assertStringContainsString("> 2) Name: '', Function: callable(['PPP\\GuzzleHttp\\Tests\\HandlerStackTest', 'bar'])", $lines[2]);
        ...
        self::assertStringContainsString("< 2) Name: '', Function: callable(['PPP\\GuzzleHttp\\Tests\\HandlerStackTest', 'bar'])", $lines[6]);
