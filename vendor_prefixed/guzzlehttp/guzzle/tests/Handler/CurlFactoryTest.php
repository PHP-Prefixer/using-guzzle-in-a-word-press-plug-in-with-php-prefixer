...
use PPP\GuzzleHttp\Handler;
use PPP\GuzzleHttp\Handler\CurlFactory;
use PPP\GuzzleHttp\Handler\EasyHandle;
use PPP\GuzzleHttp\Promise as P;
use PPP\GuzzleHttp\Psr7;
use PPP\GuzzleHttp\Tests\Helpers;
use PPP\GuzzleHttp\Tests\Server;
...
class CurlFactoryTest extends TestCase
{
    ...
    public function testRejectsPromiseWhenCreateResponseFails()
    {
        ...
        $this->expectException(\PPP\GuzzleHttp\Exception\RequestException::class);
