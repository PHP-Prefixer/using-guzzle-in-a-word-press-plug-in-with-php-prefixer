...
class ClientTest extends TestCase
{
    ...
    public function testThrowsHttpErrorsByDefault()
    {
        ...
        $this->expectException(\PPP\GuzzleHttp\Exception\ClientException::class);
    ...
    public function testSendWithInvalidHeader()
    {
        ...
        $this->expectException(\PPP\GuzzleHttp\Exception\InvalidArgumentException::class);
