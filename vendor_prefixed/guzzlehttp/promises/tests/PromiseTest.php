...
class PromiseTest extends TestCase
{
    ...
    {
        $this->expectException(\PPP\GuzzleHttp\Promise\RejectionException::class);
    ...
    {
        $this->expectException(\PPP\GuzzleHttp\Promise\CancellationException::class);
