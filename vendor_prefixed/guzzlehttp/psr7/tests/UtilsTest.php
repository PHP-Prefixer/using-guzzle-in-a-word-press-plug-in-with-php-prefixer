...
use PPP\GuzzleHttp\Psr7\FnStream;
...
class UtilsTest extends TestCase
{
    ...
    {
        self::assertInstanceOf('PPP\GuzzleHttp\Psr7\Uri', Psr7\Utils::uriFor('/foo'));
        self::assertInstanceOf(
            'PPP\GuzzleHttp\Psr7\Uri',
    ...
    public function testCreatesWithFactory(): void
    {
        ...
        self::assertInstanceOf('PPP\GuzzleHttp\Psr7\Stream', $stream);
    ...
    public function testFactoryCreatesFromEmptyString(): void
    {
        ...
        self::assertInstanceOf('PPP\GuzzleHttp\Psr7\Stream', $s);
    }
    ...
    public function testCanCreateIteratorBasedStream(): void
    {
        ...
        self::assertInstanceOf('PPP\GuzzleHttp\Psr7\PumpStream', $p);
    ...
    public function testReturnsAsIsWhenNoChanges(): void
    {
        $r1 = new Psr7\Request('GET', 'http://foo.com');
        $r2 = Psr7\Utils::modifyRequest($r1, []);
        self::assertInstanceOf('PPP\GuzzleHttp\Psr7\Request', $r2);

        $r1 = new Psr7\ServerRequest('GET', 'http://foo.com');
        $r2 = Psr7\Utils::modifyRequest($r1, []);
        self::assertInstanceOf('PPP\Psr\Http\Message\ServerRequestInterface', $r2);
    }
    ...
    public function testModifyServerRequestWithUploadedFiles(): void
    {
        ...
        self::assertInstanceOf('PPP\GuzzleHttp\Psr7\UploadedFile', $files[0]);
    }
