...
use PPP\GuzzleHttp\Psr7\LimitStream;
use PPP\GuzzleHttp\Psr7\PumpStream;
...
class PumpStreamTest extends TestCase
{
    ...
    public function testThatConvertingStreamToStringWillTriggerErrorAndWillReturnEmptyString(): void
    {
        ...
        self::assertStringStartsWith('PPP\GuzzleHttp\Psr7\PumpStream::__toString exception:', $errors[0]['message']);
    }
}
